...
class ShiroUserController {
    ...
    def save() {
        ...
        System.println "pass de confi: " + params.passwordHash2 + " pass otra: " + params.passwordHash
        if (params.passwordHash2 != params.passwordHash) {
//TODO arreglar error
			flash.message = message(code: 'default.not.found.message', args: [message(code: 'signup.password.not.match', default: 'The password does not match'), params.id])
		...
		flash.message = message(code: 'signup.confirmation.message', args: [shiroUserInstance.username])
